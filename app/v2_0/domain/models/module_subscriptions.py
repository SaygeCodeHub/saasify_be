...
from sqlalchemy import Column, Integer, ForeignKey, TIMESTAMP, Boolean, Enum, ARRAY, Date
...
class ModuleSubscriptions(Base):
    ...
    end_date = Column(Date, nullable=False, server_default=text("(current_date + interval '6 months')"))
