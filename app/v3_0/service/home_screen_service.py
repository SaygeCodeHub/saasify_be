...
from app.v3_0.schemas.task_schemas import GetTasksAssignedToMe, GetTasksAssignedByMe, Data
...
def get_build_screen_endpoint(feature_name):
    endpoint_dict = {Features.HR_ADD_ANNOUNCEMENT.name: "/buildAnnouncementForm",
                     ...
                     Features.HR_ADD_TASK.name: "/buildTaskForm",
                     Features.POS_ADD_CATEGORY: "/buildCategoryForm"}
