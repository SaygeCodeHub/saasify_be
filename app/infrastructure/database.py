...
SQLALCHEMY_DATABASE_URL_2 = "postgresql://postgres:root@localhost:5432/saasify_2.0"  # Jayraj's local instance for v2.0
# SQLALCHEMY_DATABASE_URL = "postgresql://postgres:Mun1chad$@localhost:5432/postgres"  # Aditi's local instance


# engine = create_engine(SQLALCHEMY_DATABASE_URL)
engine_2 = create_engine(SQLALCHEMY_DATABASE_URL_2)
